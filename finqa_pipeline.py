...
class FinQAPipeline(BaseMapReduceQA):
    """
    FinQA pipeline using composition for dataset loading and output formatting.

    This pipeline composes a FinQALoader with a configurable OutputFormatter
    ...
    def __init__(self,
                 ...
                 **kwargs):
        """
        Initialize FinQA pipeline with composed strategies.
        ...
        self.dataset_loader = FinQALoader(doc_dir=doc_dir)
